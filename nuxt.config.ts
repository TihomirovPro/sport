...
const cspDirectives = [
  ...
  "font-src 'self' data:",
  `script-src 'self' 'unsafe-inline' 'strict-dynamic'${isDev ? " 'unsafe-eval'" : ''} https://apis.google.com https://www.gstatic.com https://*.firebasedatabase.app https://*.firebaseio.com`,
  `script-src-elem 'self' 'unsafe-inline'${isDev ? '' : " 'strict-dynamic'"} https://apis.google.com https://www.gstatic.com https://*.firebasedatabase.app https://*.firebaseio.com${isDev ? ' http://localhost:*' : ''}`,
