...
<template lang="pug">
footer.sticky.bottom-0.flex-center.py-2.mt-auto
  //- NuxtLink(to="/profile")
  ...
  //- .addBtn.flex-center.size-16(@click="link")
  .addBtn.flex-center.size-16.bg-blue-500.rounded-full.shadow-lg(@click="link")
